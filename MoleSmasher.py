...
class MyButtonGrid(GridLayout):
    def __init__(self, **kwargs):
        ...
        self.sound_button = Button(text=f'Volume: {self.volume}', on_press=self.volume_press)
    ...
    def volume_press(self, instance):
        ...
        # อัปเดตค่า self.volume
        self.volume = self.sound.volume
        # อัปเดตข้อความของ sound_button
        instance.text = f'Volume: {int(self.volume * 10)}'
